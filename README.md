# Telegram Active Chat Users Parser with Deskgram 2
...
Try the module interface in the browser: [Open web preview](https://deskgram2.com/web-preview?path=%2Fapp-demo%2Ffunctions%2Fcollect_whore_users)
...
- [Direct Messaging](https://github.com/Deskgram-2/telegram-direct-messaging-deskgram-en) if the active base is moving into one-to-one contact.
- [Invite Tool](https://github.com/Deskgram-2/telegram-invite-tool-deskgram-en) if those users should help grow groups or channels.
- [Audience Parser](https://github.com/Deskgram-2/telegram-audience-parser-deskgram-en) if you also need a broader collection route.
- [Comment Audience Parser](https://github.com/Deskgram-2/telegram-comment-audience-parser-deskgram-en) if you want to combine chat activity with comment activity.
- [Task Manager](https://github.com/Deskgram-2/telegram-task-manager-deskgram-en) if you need the full chain visible in one control layer.
...
|---|---|
| Collect users active in live chats | [Active Chat Users Parser](https://github.com/Deskgram-2/telegram-active-chat-users-parser-deskgram-en) |
| Collect users active under channel posts | [Comment Audience Parser](https://github.com/Deskgram-2/telegram-comment-audience-parser-deskgram-en) |
...
Usually into [Direct Messaging](https://github.com/Deskgram-2/telegram-direct-messaging-deskgram-en), [Invite Tool](https://github.com/Deskgram-2/telegram-invite-tool-deskgram-en), or a segmented follow-up workflow.
